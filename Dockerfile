...
RUN echo "docker exec workbench echo "#!/bin/sh" > /nexus-bucket/workbench.sh" >> deploy-olympiad.sh
...
RUN echo "docker exec workbench echo "docker exec workbench sudo apt install -y snapd" >> /nexus-bucket/workbench.sh" >> deploy-olympiad.sh
RUN echo "docker exec workbench echo "docker exec workbench sudo snap install -y gitkraken --classic" >> /nexus-bucket/workbench.sh" >> deploy-olympiad.sh
...
RUN echo "docker exec workbench echo "docker exec workbench sudo wget https://github.com/shiftkey/desktop/releases/download/release-2.9.3-linux3/GitHubDesktop-linux-2.9.3-linux3.deb" >> workbench.sh" >> deploy-olympiad.sh
