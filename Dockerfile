...
RUN echo "docker exec workbench echo "docker exec workbench sudo wget -q -O - https://raw.githubusercontent.com/k3d-io/k3d/main/install.sh | bash" >> /nexus-bucket/workbench.sh" >> deploy-olympiad.sh
