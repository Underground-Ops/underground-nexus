...
sudo sh -c 'echo "deb [arch=arm64 signed-by=/usr/share/keyrings/shiftkey-packages.gpg] https://apt.packages.shiftkey.dev/ubuntu/ any main" >> /etc/apt/sources.list.d/shiftkey-packages.list'
